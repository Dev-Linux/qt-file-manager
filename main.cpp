 ...
 * - Doxygen bug: **\@** should produce bold text.
 *
 */
 ...
 * @retval 0 succes
 *
 * @todo (affects development speed) subclass @q{core,QFileInfo} and all the classes
 ...
 * QFileInfo fi("A:"); fi.size(); queries the floppy disk and makes a
